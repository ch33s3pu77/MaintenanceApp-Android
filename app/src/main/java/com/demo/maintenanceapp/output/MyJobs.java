...
public class MyJobs extends AppCompatActivity {
    private String JOB_ID, TYPE, PRIORITY, STATUS, LOCATION, USERNAME, appURL;
    Activity mContext = this;
    TextView mJobId, mType, mPriority, mStatus, mLocation;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, appURL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        JSONArray array = jsonObject.getJSONArray("jobOrders");
