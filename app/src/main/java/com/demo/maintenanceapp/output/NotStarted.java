...
public class NotStarted extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_not_started);
        ...
        appURL = "192.168.247.100/api/notStarted.php?User_Name=" + USERNAME;
        getJobs();
    }
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, appURL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        JSONArray array = jsonObject.getJSONArray("notStarted");
